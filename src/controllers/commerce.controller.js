...
const { Commerce, User } = require('../models');

const getAllCommerce = (req, res) =>{
    Commerce.findAll()
    .then((users) =>{
        res.send(users);
    })
                        ...
                        .then((correo) => {
                            ...
                            if(correo !== null){
                                ...
                                //     bcryptJs.hash(password, salt, (error, hash) =>{
                                        ...
                                        .then((user) => user ? res.json({message:'Comercio y Usuario creados exitosamente', id: resultado.dataValues.id }) : res.json({message:'Hubo un error al crear el usuario'}))
                                        .catch((err) => {
...
module.exports = {getAllCommerce, createCommerce, updateCommerce};